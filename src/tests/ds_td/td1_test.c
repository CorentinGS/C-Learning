...
int test_smallest_element(void);
int test_get_min_index(void);
int test_get_min_index_between(void);
int test_sum_array(void);
int test_average_array(void);
int test_sum_array_between(void);
int test_average_array_between(void);
int test_extract_firstname(void);
...
int
test_average_array_between(void) {
    int array[] = {0, 1, 2, 3, 4, 5, 6};
...
int
test_get_min_index_between(void) {
    int array[] = {1, 2, 3, 4, 5};
